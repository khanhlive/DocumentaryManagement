...
export default class DocumentaryInternalEditComponent extends EditComponentBase<IDocumentaryEditProps, IDocumentaryEditState> {
        ...
        return (
            <Modal show={this.state.isShow} onHide={() => this.setState({ isShow: false })} dialogClassName="modal-large-80vw" autoFocus={true}>
                ...
                <Modal.Header closeButton>
                    <Modal.Title>{this.state.isEdit ? 'Cập nhật' : 'Thêm mới '} văn bản nội bộ</Modal.Title>
                </Modal.Header>
                        ...
                        <form ref={ref => this.form = ref || undefined} className="form-horizontal form-no-padding" onSubmit={this.onSubmit.bind(this)}>
                            ...
                            <div className="row">
                                <div className="form-group">
                                    ...
                                    <div className="col-md-11">
                                        <AttachmentsCommon onChange={this.handleAttachmentChange} ref={ref => this.attachmentRef = ref || undefined} id={this.state.model.id || 0} type={DocumentaryType.DocumentaryInternal}></AttachmentsCommon>
                                    </div>
                                </div>
                            </div>
                        </form>
