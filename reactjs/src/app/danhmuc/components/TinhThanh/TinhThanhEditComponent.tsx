...
export interface IProvinceEditProps extends IEditComponentProps {

}
export interface IProvinceEditState extends IEditComponentStates {
...
const validationRules = {
    ...
    fields: {
        ...
        name: {
            ...
            validators: {
                notEmpty: {
                    message: "Bạn chưa nhập tên tỉnh"
                },
                stringLength: {
                    max: 250,
        ...
        level: {
            ...
            validators: {
                notEmpty: {
                    message: "Bạn chưa nhập cấp tỉnh thành"
                },
                stringLength: {
                    max: 250,
                    message: "Nhập tối đa 250 ký tự"
...
export default class ProvinceEditComponent extends EditComponentBase<IProvinceEditProps, IProvinceEditState> {
        ...
        return (
            <Modal show={this.state.isShow} onHide={() => this.setState({ isShow: false })}>
                ...
                <Modal.Header closeButton>
                    <Modal.Title>{this.state.isEdit ? 'Cập nhật' : 'Thêm mới '} tỉnh thành</Modal.Title>
                </Modal.Header>
                    ...
                    <BootstrapValidator ref={ref => this.validator = ref || undefined} options={validationRules}>
                        ...
                        <div ref={ref => this.divForm = ref || undefined} className="form-horizontal">
                            <div className="form-group">
                                <label className="control-label col-md-2">Mã tỉnh<span className="text-required">(*)</span></label>
                            ...
                            <div className="form-group">
                                <label className="control-label col-md-2">Tên tỉnh<span className="text-required">(*)</span></label>
                                <div className="col-md-10">
                            ...
                            <div className="form-group">
                                <label className="control-label col-md-2">Cấp<span className="text-required">(*)</span></label>
                                <div className="col-md-10">
                                    <input type="text" onChange={this.handleInputChange.bind(this)} name="level" value={this.state.model.level} className="form-control"></input>
                                </div>
                            </div>
                            <div className="form-group">
