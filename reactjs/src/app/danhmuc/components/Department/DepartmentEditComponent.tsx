...
export interface IDepartmentEditProps extends IEditComponentProps {

}
export interface IDepartmentEditState extends IEditComponentStates {
...
const validationRules = {
    ...
    fields: {
        code: {
            ...
            validators: {
                notEmpty: {
                    message: "Bạn chưa nhập mã phòng ban"
                },
                stringLength: {
                    max: 50,
...
export default class DepartmentEditComponent extends EditComponentBase<IDepartmentEditProps, IDepartmentEditState> {
        ...
        return (
            <Modal show={this.state.isShow} onHide={() => this.setState({ isShow: false })}>
                ...
                <Modal.Header closeButton>
                    <Modal.Title>{this.state.isEdit ? 'Cập nhật' : 'Thêm mới '} phòng ban</Modal.Title>
                </Modal.Header>
                    ...
                    <BootstrapValidator ref={ref => this.validator = ref || undefined} options={validationRules}>
                        ...
                        <div ref={ref => this.divForm = ref || undefined} className="form-horizontal">
                            <div className="form-group">
                                <label className="control-label col-md-3">Mã phòng/ban<span className="text-required">(*)</span></label>
                            ...
                            <div className="form-group">
                                <label className="control-label col-md-3">Tên phòng/ban<span className="text-required">(*)</span></label>
                                <div className="col-md-9">
