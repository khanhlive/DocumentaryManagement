...
class OutlookDetail extends React.Component {
  ...
  componentDidMount() {
    if (this.currentMessage !== this.props.match.params.id) {
      this.props.dispatch(outlookFetchMeesage(this.props.match.params.id));
      this.currentMessage = this.props.match.params.id;
    }
  }
    ...
    return (
      <div className="table-wrap custom-scroll">
        <h2 className="email-open-header">
          {message.subject}
          <span className="label txt-color-white">{message.folder}</span>
          <OverlayTrigger
            placement="left"
          ...
          <div className="row">
            <div className="col-sm-9">
              ...
              <span className="hidden-mobile">
                &lt;{message.contact.email}&gt;to <strong>me</strong> on
                <i>
            ...
            <div className="col-sm-3 text-right">
              <Dropdown
                className="btn-group text-left"
                id="replay-message-dropdown"
              >
                <Link
                  to={"/outlook/replay/" + message._id}
                ...
                <Dropdown.Menu className="dropdown-menu pull-right">
                  <MenuItem
                    href={"#/outlook/replay/" + message._id}
                    className="replythis"
                  >
                    <i className="fa fa-reply" /> Reply
                  </MenuItem>
