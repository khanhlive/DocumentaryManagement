    ...
    <WidgetGrid>
      <div className="row">
        <article className="col-sm-12">
          <JarvisWidget editbutton={false} color="blueDark" id="OrdersWidget">
            <header>
                    ...
                    <tr>
                      ...
                      <th className="hasinput icon-addon">
                        ...
                        <label
                          ...
                          rel="tooltip"
                          title=""
                          data-original-title="Purchase Date"
                        />
                      </th>
