...
import UiProgressbar from "../../../../common/ui/components/UiProgressbar";
import {
  smallBox,
  bigBox,
  SmartMessageBox
...
export default class UiGeneral extends React.Component {
  ...
  render() {
    return (
      <div id="content">
        <div className="row">
          <BigBreadcrumbs
            items={["UI Elements", "General Elemants"]}
        ...
        <WidgetGrid>
                ...
                <div>
                  ...
                  <div className="widget-body">
                    <p className="alert alert-info no-margin">
                      ...
                      <code>.progress</code>. Control the size of the progress
                      bar with
                    ...
                    <div className="row">
                      <div className="col-sm-12">
                        ...
                        <p>
                          This nifty animated progress bars run on CSS combined
                          with javascript
                        </p>
                        <p>
                          You will simply need to add in the value
                          <code>data-transitiongoal="25"</code>
                          ...
                          <div className="col-sm-6">
                            ...
                            <div className="well no-padding">
                              <div className="bar-holder">
                                ...
                                >
                                  <UiProgressbar
                                    className="progress-bar bg-color-teal"
                      ...
                      <div className="col-sm-12">
                        ...
                        <div className="row">
                          <div className="col-sm-6 col-md-6 col-lg-3">
                            <p>
                              Add an overlapping div to progress-bar with the
                              base css of
                              <code>.progress .vertical</code>
                            </p>
                          ...
                          <div className="col-sm-6 col-md-6 col-lg-3">
                            <p>
                              Add an overlapping div to progress-bar with the
                              base css of
                              <code>.progress .vertical .bottom</code>
                            </p>
                          ...
                          <div className="col-sm-6 col-md-6 col-lg-3">
                            <p>
                              Add an overlapping div to progress-bar with the
                              base css of
                              <code>.progress .vertical .wide-bar</code>
                            </p>
                    ...
                    <div className="row">
                      <div className="col-sm-12">
                        ...
                        <p>
                          Micro progress bar <code>.progress-micro</code>
                          with
                          <code>.progress-bar-primary</code>
                        </p>
                        ...
                        <p>
                          Extra small progress bar <code>.progress-xs</code>
                          with
                          <code>.bg-color-blue</code>
                          <span className="txt-color-blue pull-right">
                        ...
                        <p>
                          Small progress bar <code>.progress-sm</code>
                          with
                          <code>.bg-color-greenLight</code>
                          <span className="txt-color-green pull-right">
                        ...
                        <p>
                          ...
                          <code>.bg-color-redLight</code>
                          <span className="txt-color-red pull-right">
                        ...
                        <p>
                          Large progress bars <code>.progress-lg</code>
                          with
                          <code>.bg-color-blueLight</code>
                          <span className="txt-color-blueLight pull-right">
                        ...
                        <p>
                          Sriped Progress bars made with CSS3 gradients, by
                          adding the
                          <code>.progress-striped</code> class to the base class
                        </p>
                        <p>
                          <span className="label label-info">Info!</span> Please
                          be aware that this will not work in archaic browsers
                          such as IE9
                          <span className="txt-color-purple pull-right">
                            <i className="fa fa-warning" /> 80% Complete
                          </span>
                        </p>
                        <div className="progress">
                          <div className="progress progress-striped">
                            <div
                              className="progress-bar bg-color-purple"
                              role="progressbar"
                              style={{ width: "77%" }}
                            />
                          </div>
                        ...
                        <p>
                          Activate and animate a progress bar by adding the
                          class
                          <code>.progress-striped .active</code>
                        </p>
                        <p>
                          Dark progress bar with class
                          <code>.bg-color-darken</code>
                          <span className="txt-color-orange pull-right">
                            <i className="fa fa-lg fa-times" />
                          </span>
                        </p>
                        <div className="progress progress-sm progress-striped active">
                          <div
                            className="progress-bar bg-color-darken"
                            role="progressbar"
                            style={{ width: "45%" }}
                          />
                        </div>
                        ...
                        <p>
                          Stack one progressbar on top of another by including
                          all in one
                          <code>div.progress</code>
                          <span
                            className="sparkline inline-block pull-right"
                        ...
                        <div className="progress progress-sm">
                          ...
                          />
                          <div
                            className="progress-bar bg-color-yellow"
                            style={{ width: "20%" }}
                          />
                          <div
                            className="progress-bar bg-color-redLight"
          ...
          <div className="row">
            <h2 className="row-seperator-header">
              <i className="fa fa-plus" /> Customized Tabs
            </h2>
                  ...
                  <div className="widget-body">
                    ...
                    <ul id="myTab1" className="nav nav-tabs bordered">
                      ...
                      <li className="dropdown">
                        <a href="#/" onClick={this.onClick} className="dropdown-toggle">
                      ...
                      <li className="pull-right">
                        <a href="#/" onClick={this.onClick}>
                          <div
                            className="sparkline txt-color-pinkDark text-align-right"
                            data-sparkline-height="18px"
                  ...
                  <div className="widget-toolbar hidden-phone">
                    <div className="smart-form">
                      <label className="toggle">
                        <input
                          type="checkbox"
                          id="demo-switch-to-pills"
                          name="checkbox-toggle"
                        />
                        <i data-swchon-text="TRUE" data-swchoff-text="FALSE" />
                        Switch Navs / Pills
                      </label>
                    </div>
                  </div>
                    ...
                    <div className="tabs-left">
                      <ul className="nav nav-tabs tabs-left" id="demo-pill-nav">
                        ...
                        <li>
                          <a href="#tab-r2" data-toggle="tab">
                            <span className="badge bg-color-blueDark txt-color-white">
                              3
                            </span>
                            Item 2
                          </a>
                        ...
                        <li>
                          <a href="#tab-r3" data-toggle="tab">
                            <span className="badge bg-color-greenLight txt-color-white">
                              0
                            </span>
                            Item 3
                          </a>
                      ...
                      <div className="tab-content">
                        <div className="tab-pane active" id="tab-r1">
                          ...
                          <p>
                            They say that love is more important than money, but
                  ...
                  <ul className="nav nav-tabs pull-left in">
                    <li className="active">
                      <a data-toggle="tab" href="#hr1">
                        <i className="fa fa-lg fa-arrow-circle-o-down" />
                    ...
                    <li>
                      <a data-toggle="tab" href="#hr2">
                        <i className="fa fa-lg fa-arrow-circle-o-up" />
                        <span className="hidden-mobile hidden-tablet">
                          Top Tabs
                          <span className="label bg-color-blue txt-color-white">
                            label <i className="fa fa-exclamation" />
                          </span>
                        </span>
                      </a>
                    </li>
                          ...
                          <div className="tab-content padding-10">
                            <div className="tab-pane active" id="AA">
                              <p>
                                ...
                                the mushroom says 'I look like an umbrella', the
                                walnut says 'I look like a brain', and the
                      ...
                      <div className="tab-pane" id="hr2">
                        ...
                        <div className="tab-content padding-10">
                          <div className="tab-pane active" id="iss1">
                            <p>
                              Three monkeys escaped from the zoo, one was caught
                              watching TV, the other playing hockey, and the
                              third one was caught reading this quote!
                            </p>
                          </div>
              ...
              >
                ...
                <div>
                  ...
                  <div className="widget-body">
                    ...
                    <ul
                      id="myTab3"
                      className="nav nav-tabs tabs-pull-right bordered"
                    >
                      <li className="active">
                        <a href="#l1" data-toggle="tab">
                          Tab Item 1
                          <span className="badge bg-color-pinkDark txt-color-white">
                            99
                          </span>
                        </a>
                      </li>
                      ...
                      <div className="tab-content">
                        <div className="tab-pane active" id="tab1">
                          <p>
                            ...
                            <br />
                            HARDWARE: The part of a computer you can kick when
                  ...
                  <div className="widget-body">
                    <div className="tab-content">
                        ...
                        <div className="tabbable tabs-below">
                          <div className="tab-content padding-10">
                            <div className="tab-pane active" id="A1">
                              <p>
                                When I stare at the sky, I see you. When I stare
                                out into the ocean, I see you. When I'm looking
                                at the moon, I see you. Geez! Would you move
                                aside, you're constantly getting in my way!
                              </p>
                            </div>
                      ...
                      <div className="tab-pane" id="hb2">
                        <ul
                          id="internal-tab-1"
                          className="nav nav-tabs tabs-pull-right"
                        >
                          <li className="active">
                        ...
                        <div className="tab-content padding-10">
                          <div className="tab-pane active" id="is1">
                            <p>
                              ...
                              I love to stay away from others, and some I'd just
                              love to punch right in the face!
                            </p>
                          </div>
          ...
          <div className="row">
            <h2 className="row-seperator-header">
              <i className="fa fa-reorder" /> Default Nav Bars
            </h2>
            ...
            <article className="col-sm-12">
              <div className="navbar navbar-default">
                ...
                <div className="navbar-header">
                  ...
                  <a href="#/" className="navbar-brand" onClick={this.onClick}>
                    Brand
                  </a>
                </div>
                ...
                >
                  <ul className="nav navbar-nav">
                    <li className="active">
                      <a href="#/" onClick={this.onClick}>Link</a>
                    </li>
                    <li>
                      <a href="#/" onClick={this.onClick}>Link</a>
                    </li>
                    <li className="dropdown dropdown-large">
                      <a href="#/" onClick={this.onClick} className="dropdown-toggle">
                        Large Dropdown <b className="caret" />
                      </a>
                      ...
                      <ul className="dropdown-menu dropdown-menu-large row">
                        <li className="col-sm-3">
                          <ul>
                            ...
                            <li>
                              <a href="#/" onClick={this.onClick}>Available glyphs</a>
                            </li>
                            <li className="disabled">
                              <a href="#/" onClick={this.onClick}>How to use</a>
                            </li>
                            <li>
                              <a href="#/" onClick={this.onClick}>Examples</a>
                            </li>
                            <li className="divider" />
                            <li className="dropdown-header">Dropdowns</li>
                            <li>
                              <a href="#/" onClick={this.onClick}>Example</a>
                            </li>
                            <li>
                              <a href="#/" onClick={this.onClick}>Aligninment options</a>
                            </li>
                            <li>
                              <a href="#/" onClick={this.onClick}>Headers</a>
                            </li>
                            <li>
                              <a href="#/" onClick={this.onClick}>Disabled menu items</a>
                            </li>
                          </ul>
                        </li>
                        <li className="col-sm-3">
                          <ul>
                            ...
                            <li>
                              <a href="#/" onClick={this.onClick}>Basic example</a>
                            </li>
                            <li>
                              <a href="#/" onClick={this.onClick}>Button toolbar</a>
                            </li>
                            <li>
                              <a href="#/" onClick={this.onClick}>Sizing</a>
                            </li>
                            <li>
                              <a href="#/" onClick={this.onClick}>Nesting</a>
                            </li>
                            <li>
                              <a href="#/" onClick={this.onClick}>Vertical variation</a>
                            </li>
                            <li className="divider" />
                        ...
                        <li className="col-sm-3">
                          <ul>
                            ...
                            <li>
                              <a href="#/" onClick={this.onClick}>Tabs</a>
                            </li>
                            <li>
                              <a href="#/" onClick={this.onClick}>Pills</a>
                            </li>
                            <li>
                              <a href="#/" onClick={this.onClick}>Justified</a>
                            </li>
                          </ul>
                        </li>
                        <li className="col-sm-3">
                          <ul>
                            ...
                            <li>
                              <a href="#/" onClick={this.onClick}>Default navbar</a>
                            </li>
                            <li>
                              <a href="#/" onClick={this.onClick}>Buttons</a>
                            </li>
                            <li>
                              <a href="#/" onClick={this.onClick}>Text</a>
                            </li>
                            <li>
                              <a href="#/" onClick={this.onClick}>Non-nav links</a>
                            </li>
                            <li>
                              <a href="#/" onClick={this.onClick}>Component alignment</a>
                            </li>
                            <li>
                              <a href="#/" onClick={this.onClick}>Fixed to top</a>
                            </li>
                            <li>
                              <a href="#/" onClick={this.onClick}>Fixed to bottom</a>
                            </li>
                            <li>
                              <a href="#/" onClick={this.onClick}>Static top</a>
                            </li>
                            <li>
                              <a href="#/" onClick={this.onClick}>Inverted navbar</a>
                            </li>
                          </ul>
                        </li>
                      </ul>
          ...
          <div className="row">
            ...
            <br />
            <h2 className="row-seperator-header">
              <i className="fa fa-tag" /> Labels and Badges
            </h2>
                ...
                <div className="row">
                  ...
                  <div className="col-sm-12">
                    <p className="alert alert-info">
                      <i className="fa fa-info" /> Did you know you can add more
                      than just the basic colors to customize your badge?
                      <strong>
                        Learn more about color options modifiers on the
                        ...
                        <table className="table table-bordered">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>
                                <span className="badge bg-color-darken">1</span>
                              </td>
                            </tr>
                            <tr>
                              <td>
                              ...
                              <td>
                                <span className="badge bg-color-greenLight">
                                  22
                                </span>
                              </td>
                            </tr>
                            <tr>
                              ...
                              <td>
                                <span className="badge bg-color-blueLight">
                                  30
                                </span>
                              </td>
                            </tr>
                            <tr>
                              ...
                              <td>
                                <span className="badge bg-color-orange">
                                  412
                                </span>
                              </td>
                            </tr>
                            <tr>
                              ...
                              <td>
                                <span className="badge bg-color-red">999</span>
                              </td>
                            </tr>
                          </tbody>
                        </table>
          ...
          <div className="row">
            <h2 className="row-seperator-header">
              <i className="fa fa-comments" /> Block Messages
            </h2>
            ...
            <div className="col-sm-12">
              ...
              <div className="alert alert-danger alert-block">
                ...
                <p className="text-align-left">
                  <br />
                  <a href="#/" onClick={this.onClick} className="btn btn-sm btn-default">
          ...
          <div className="row">
            <h2 className="row-seperator-header">
              <i className="fa fa-warning" /> Alerts and Notifications
            </h2>
              ...
              <div className="row">
                <div className="col-sm-12 col-md-12 col-lg-6">
                  ...
                  <div className="well">
                    ...
                    <p>
                      ...
                      below. It will slide down and fade in from the top of the
                      page.
                    </p>
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                              ...
                              specify
                              <code>static</code> for a backdrop which doesn't
                          ...
                          <tr>
                            ...
                            <td>
                              <p>
                                If a remote URL is provided, content will be
                                loaded via jQuery's
                                <code>load</code>
                                method and injected into the root of the modal
                                element. If you're using the data-api, you may
                                alternatively use the
                                <code>href</code>
                                attribute to specify the remote source. An
                            ...
                            <td colSpan="4">
                              <pre>
                                <code className="html">
                                  ...
                                  <span className="na">data-toggle=</span>
                                  <span className="s">"modal"</span>
                                  <span className="na">href=</span>
                                  <span className="s">"remote.html"</span>
                                  <span className="na">data-target=</span>
                                  <span className="s">"#modal"</span>
                                  <span className="nt">&gt;</span>
                                  Click me<span className="nt">&lt;/a&gt;</span>
                                </code>
                              </pre>
                            </td>
                          </tr>
                ...
                <div className="col-sm-12 col-md-12 col-lg-6">
                  ...
                  <div className="well">
                    ...
                    <p>
                      Clutter free dynamic alert box, easy to configure and
                      setup!
                    </p>
                    <p>
                      <span className="label label-info">
                        <i className="fa fa-music" /> Sound Enabled
                      </span>
                    </p>
                    ...
                    <h5>Live Demo</h5>
                    <p className="note">
                      <span className="label bg-color-darken txt-color-white">
                        INFO!
                      </span>
                      Messages are tabbale and does not overpopulate the user
                      screen. Sounds can also be disabled if not needed
                    </p>

                    <ul className="demo-btns">
                      <li>
                        <a href="#/" onClick={this._eg1} className="btn btn-primary">
                          <i className="fa fa-warning" /> Example 1
                        </a>
                      </li>
                      <li>
                        <a href="#/" onClick={this._eg2} className="btn btn-primary">
                          <i className="fa fa-bell" /> Example 2
                        </a>
                      </li>
                      <li>
                        <a href="#/" onClick={this._eg3} className="btn btn-primary">
                          <i className="fa fa-shield" /> Example 3
                        </a>
                      </li>
                      <li>
                        <a href="#/" onClick={this._eg4} className="btn btn-primary">
                          <i className="fa fa-check" /> Example 4
                        </a>
                      </li>
                    </ul>
                    ...
                    <p className="note">
                      Easily customize the alerts to any colors of your choice,
                      and add any icons from the theme library with animation!
                    </p>
                  ...
                  <div className="well">
                    ...
                    <h5 className="text-success">
                      With Callback and Buttons
                      <small>(Dynamic Example)</small>
                    </h5>
                    <ul className="demo-btns">
                      <li>
                        <a href="#/"
                          onClick={this._smartModEg1}
          ...
          <div className="row">
            <h2 className="row-seperator-header">
              <i className="fa fa-question" /> Tooltips and Popovers
            </h2>
              ...
              <div className="row">
                <div className="col-sm-12 col-md-12 col-lg-6">
                  <div className="well">
                    <h3>Tooltips</h3>
                    <p>
                      Tip your users with a small tooltip. Nifty helpful
                      information can be disaplayed using this very simple and
                      yet effictive component. Display pure
                      <strong>HTML Content</strong>, <strong>Images</strong> and
                      <strong>Icons</strong>
                    </p>
                    <br />
                    ...
                    <ul className="demo-btns text-center">
                      <li>
                        <OverlayTrigger
                          placement="top"
                          overlay={
                            <Tooltip id="h-1-b-one-b-em-really-em-big-tip-h-1-tooltip">
                              <h1>
                                <b>One</b> <em>Really</em> big tip!
                              </h1>
                            </Tooltip>
                          }
                        >
                      ...
                      <li>
                        <OverlayTrigger
                          placement="top"
                          overlay={
                            <Tooltip id="i-class-fa-fa-check-fa-3-x-text-success-i-i-class-fa-fa-times-fa-3-x-text-danger-i-tooltip">
                      ...
                      <li>
                        ...
                        >
                          <a href="#/" onClick={this.onClick} className="btn btn-default">
                            <i className="fa fa-arrow-left" /> Tooltip Left
                          </a>
                        </OverlayTrigger>
                      </li>
                      <li>
                        ...
                        >
                          <a href="#/" onClick={this.onClick} className="btn btn-default">
                            <i className="fa fa-arrow-up" /> Tooltip Top
                          </a>
                        </OverlayTrigger>
                      </li>
                      <li>
                        <OverlayTrigger
                          placement="bottom"
                          overlay={
                            <Tooltip id="tooltip-bottom-tooltip">
                              Tooltip Bottom
                            </Tooltip>
                          }
                        >
                          <a href="#/" onClick={this.onClick} className="btn btn-default">
                            <i className="fa fa-arrow-down" /> Tooltip Bottom
                          </a>
                        </OverlayTrigger>
                      </li>
                      <li>
                        <OverlayTrigger
                          placement="right"
                          overlay={
                            <Tooltip id="i-class-fa-fa-check-text-success-i-tooltip-right-tooltip">
                              <i className="fa fa-check text-success" /> Tooltip
                              Right
                            </Tooltip>
                          }
                        >
                          <a href="#/" onClick={this.onClick} className="btn btn-default">
                            <i className="fa fa-arrow-right" /> Tooltip Right
                          </a>
                        </OverlayTrigger>
                      </li>
                    </ul>
                ...
                <div className="col-sm-12 col-md-12 col-lg-6">
                  <div className="well">
                    <h3>Popovers</h3>
                    <p>
                      Popovers are a cool way to express compressed information
                      to the user, neatly and quickly. You can generate all
                      kinds of content within the popover component. Including
                      <strong>Forms</strong>,<strong>Tabs</strong>,
                      <strong>Images</strong> and even
                    ...
                    <ul className="demo-btns text-center">
                      ...
                      <li>
                        <OverlayTrigger
                          ...
                          placement="top"
                          overlay={
                            <Popover id="h-4-tabs-inside-popover-h-4-popover">
                              <ul
                                id="popup-tab"
                                className="nav nav-tabs bordered"
                              >
                                <li className="active">
                                  <a href="#pop-1" data-toggle="tab">
                                    Active Tab
                                  </a>
                                </li>
                                <li>
                                  <a href="#pop-2" data-toggle="tab">
                                    Tab 2
                                  </a>
                                </li>
                              </ul>
                              <div
                                id="popup-tab-content"
                        ...
                        >
                          <a href="#/" className="btn btn-default btn-lg">
                            <strong>Active</strong> <i>Content</i>
                          </a>
                        </OverlayTrigger>
                      </li>
                      <li>
                        <OverlayTrigger
                          ...
                          placement="top"
                          overlay={
                            <Popover id="i-class-fa-fa-fw-fa-pencil-i-form-inside-popover-popover">
                              <form
                                action="/api/plug"
                    ...
                    <ul className="demo-btns text-center">
                      <li>
                        <OverlayTrigger
                          placement="left"
                          overlay={
                            <Popover id="popover-left-popover">
                              Sed posuere consectetur est at lobortis. Aenean eu
                              leo quam. Pellentesque ornare sem lacinia quam
                              venenatis vestibulum.
                            </Popover>
                        ...
                        >
                          <a href="#/" onClick={this.onClick} className="btn btn-default">
                            ...
                            <strong>Popover</strong> <i>Left</i>
                          </a>
                        </OverlayTrigger>
                      </li>
                      <li>
                      ...
                      <li>
                        <OverlayTrigger
                          placement="bottom"
                          overlay={
                            <Popover id="popover-down-popover">
                              Sed posuere consectetur est at lobortis. Aenean eu
                              leo quam. Pellentesque ornare sem lacinia quam
                              venenatis vestibulum.
                            </Popover>
                        ...
                        >
                          <a href="#/" onClick={this.onClick} className="btn btn-default">
                            ...
                            <strong>Popover</strong> <i>Down</i>
                          </a>
                        </OverlayTrigger>
                      </li>
                      <li>
                        <OverlayTrigger
                          placement="right"
                          overlay={
                            <Popover id="popover-right-popover">
                              Sed posuere consectetur est at lobortis. Aenean eu
                              leo quam. Pellentesque ornare sem lacinia quam
                              venenatis vestibulum.
                            </Popover>
                        ...
                        >
                          <a href="#/" onClick={this.onClick} className="btn btn-default">
                            ...
                            <strong>Popover</strong> <i>Right</i>
                          </a>
                        </OverlayTrigger>
                      </li>
                    </ul>
          ...
          <div className="row">
            <h2 className="row-seperator-header">
              <i className="fa fa-square-o" /> Containers, Media and Pagination
            </h2>
            <div className="col-sm-12 col-md-12 col-lg-6">
              <div className="well">
                <h3>
                ...
                <p>
                  Learn more about other colors that you can use for .well by
                  going to <a href="typography.html">typography page</a>
                </p>
              </div>
            </div>
            ...
            <div className="col-sm-12 col-md-12 col-lg-6">
              <div className="well">
                ...
                <ul className="media-list">
                  <li className="media">
                    <a href="#/" className="pull-left" onClick={this.onClick}>
                      <img
                ...
                <div style={{ width: "200px", margin: "0 auto" }}>
                  <ul className="pager">
                    <li className="previous disabled">
                      <a href="#/" onClick={this.onClick}>&larr; Older</a>
                    </li>
                    <li className="next">
                      <a href="#/" onClick={this.onClick}>Newer &rarr;</a>
                    </li>
                  </ul>
                </div>
              </div>
  ...
  _eg5() {
    smallBox({
      title: "Ding Dong!",
      content:
        "Someone's at the door...shall one get it sir? <p class='text-align-right'><a href='#' class='btn btn-primary btn-sm'>Yes</a> <a href='#' class='btn btn-danger btn-sm'>No</a></p>",
      color: "#296191",
      //timeout: 8000,
      icon: "fa fa-bell swing animated"
    });
