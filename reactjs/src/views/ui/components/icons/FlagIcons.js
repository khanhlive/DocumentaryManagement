                ...
                <div>
                  ...
                  <div className="widget-body" ref="demoContainer">
                    <div className="alert alert-info">
                      <i className="fa fa-exclamation" /> Please note: flag
                      images has a base class for image <code>flag flag-*</code>
                      . A full example of this in use will be as follows:{" "}
                      <code>
